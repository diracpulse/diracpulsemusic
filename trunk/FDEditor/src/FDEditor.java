...
public class FDEditor extends JFrame {
	...
	public void initTestData() {
		...
		try {
			...
			addDataInterpolate(new FDData(25, 31.0 * 9.0, 11.0), new FDData(75, 31.0 * 10.0, 0.0), true);
			addDataInterpolate(new FDData(100, 31.0 * 8.0, 10.0), new FDData(150, 31.0 * 9.0, 0.0), true);
		} catch (Exception e) {
